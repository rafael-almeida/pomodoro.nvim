...
local setup = function()
    ...
    vim.keymap.set("n", "<leader>ttn", start_timer, { noremap = true, silent = true }) -- start session
    vim.keymap.set("n", "<leader>tts", stop_timer, { noremap = true, silent = true })  -- stop session
